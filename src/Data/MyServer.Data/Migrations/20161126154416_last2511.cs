...
{
    public partial class last2511 : Migration
    {
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    table.PrimaryKey("PK_ImageGpsDatas", x => x.Id);
                });
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    CreatedOn = table.Column<DateTime>(nullable: false),
                    DeletedOn = table.Column<DateTime>(nullable: true),
                    DescriptionBg = table.Column<string>(maxLength: 3000, nullable: true),
                    DescriptionEn = table.Column<string>(maxLength: 3000, nullable: true),
                    IsDeleted = table.Column<bool>(nullable: false),
                    ModifiedOn = table.Column<DateTime>(nullable: true),
                    TitleBg = table.Column<string>(maxLength: 200, nullable: false),
            ...
            migrationBuilder.CreateIndex(
                name: "IX_Images_ImageGpsDataId",
                table: "Images",
                column: "ImageGpsDataId");
