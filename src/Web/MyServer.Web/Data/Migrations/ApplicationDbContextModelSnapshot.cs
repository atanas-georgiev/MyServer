namespace MyServer.Web.Data.Migrations
{
    using System;
    ...
    partial class ApplicationDbContextModelSnapshot : ModelSnapshot
    {
        ...
        {
            modelBuilder.HasAnnotation("ProductVersion", "1.0.0-rc3").HasAnnotation(
            ...
            modelBuilder.Entity(
                "MyServer.Models.ApplicationUser",
                b =>
                    {
                        b.Property<string>("Id");
            ...
            modelBuilder.Entity(
                ...
                b =>
                    {
                        b.HasOne("MyServer.Models.ApplicationUser").WithMany("Claims").HasForeignKey("UserId")
            ...
            modelBuilder.Entity(
                ...
                b =>
                    {
                        b.HasOne("MyServer.Models.ApplicationUser").WithMany("Logins").HasForeignKey("UserId")
                            .OnDelete(DeleteBehavior.Cascade);
                    });
                ...
                b =>
                    {
                        ...
                        b.HasOne("MyServer.Models.ApplicationUser").WithMany("Roles").HasForeignKey("UserId")
                            .OnDelete(DeleteBehavior.Cascade);
                    });
        }
    }
