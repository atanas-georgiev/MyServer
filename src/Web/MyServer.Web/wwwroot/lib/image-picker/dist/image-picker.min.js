...
(function() {
  ...
  ImagePickerOption = (function() {
    ...
    ImagePickerOption.prototype.mark_as_selected = function () {
        this.node.find("i").removeClass("fa-square-o")
        this.node.find("i").addClass("fa-check-square-o")
      return this.node.find(".thumbnail").addClass("selected");
    };

    ImagePickerOption.prototype.unmark_as_selected = function () {
        this.node.find("i").removeClass("fa-check-square-o")
        this.node.find("i").addClass("fa-square-o")
    ...
    ImagePickerOption.prototype.create_node = function() {
      ...
      checkbox = jQuery("<div class='overlay-album-caption'>" +
          ...
          "<i class='fa fa-check-square-o' aria-hidden='true'></i>" + "</div></div>");
